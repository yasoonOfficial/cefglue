namespace CefGlue
{
    ...
    {
        Failed = cef_handler_errorcode_t.ERR_FAILED,
        Aborted = cef_handler_errorcode_t.ERR_ABORTED,
        InvalidArgument = cef_handler_errorcode_t.ERR_INVALID_ARGUMENT,
        InvalidHandle = cef_handler_errorcode_t.ERR_INVALID_HANDLE,
        FileNotFound = cef_handler_errorcode_t.ERR_FILE_NOT_FOUND,
        TimedOut = cef_handler_errorcode_t.ERR_TIMED_OUT,
        FileTooBig = cef_handler_errorcode_t.ERR_FILE_TOO_BIG,
        Unexpected = cef_handler_errorcode_t.ERR_UNEXPECTED,
        AccessDenied = cef_handler_errorcode_t.ERR_ACCESS_DENIED,
        NotImplemented = cef_handler_errorcode_t.ERR_NOT_IMPLEMENTED,

        ConnectionClosed = cef_handler_errorcode_t.ERR_CONNECTION_CLOSED,
        ConnectionReset = cef_handler_errorcode_t.ERR_CONNECTION_RESET,
        ConnectionRefused = cef_handler_errorcode_t.ERR_CONNECTION_REFUSED,
        ConnectionAborted = cef_handler_errorcode_t.ERR_CONNECTION_ABORTED,
        ConnectionFailed = cef_handler_errorcode_t.ERR_CONNECTION_FAILED,
        NameNotResolved = cef_handler_errorcode_t.ERR_NAME_NOT_RESOLVED,
        InternetDisconnected = cef_handler_errorcode_t.ERR_INTERNET_DISCONNECTED,
        SslProtocolError = cef_handler_errorcode_t.ERR_SSL_PROTOCOL_ERROR,
        AddressInvalid = cef_handler_errorcode_t.ERR_ADDRESS_INVALID,
        AddressUnreachable = cef_handler_errorcode_t.ERR_ADDRESS_UNREACHABLE,
        SslClientAuthCertNeeded = cef_handler_errorcode_t.ERR_SSL_CLIENT_AUTH_CERT_NEEDED,
        TunnelConnectionFailed = cef_handler_errorcode_t.ERR_TUNNEL_CONNECTION_FAILED,
        NoSslVersionsEnabled = cef_handler_errorcode_t.ERR_NO_SSL_VERSIONS_ENABLED,
        SslVersionOrCipherMismatch = cef_handler_errorcode_t.ERR_SSL_VERSION_OR_CIPHER_MISMATCH,
        SslRenegotiationRequested = cef_handler_errorcode_t.ERR_SSL_RENEGOTIATION_REQUESTED,

        CertCommonNameInvalid = cef_handler_errorcode_t.ERR_CERT_COMMON_NAME_INVALID,
        CertDateInvalid = cef_handler_errorcode_t.ERR_CERT_DATE_INVALID,
        CertAuthorityInvalid = cef_handler_errorcode_t.ERR_CERT_AUTHORITY_INVALID,
        CertContainsErrors = cef_handler_errorcode_t.ERR_CERT_CONTAINS_ERRORS,
        CertNoRevocationMechanism = cef_handler_errorcode_t.ERR_CERT_NO_REVOCATION_MECHANISM,
        CertUnableToCheckRevocation = cef_handler_errorcode_t.ERR_CERT_UNABLE_TO_CHECK_REVOCATION,
        CertRevoked = cef_handler_errorcode_t.ERR_CERT_REVOKED,
        CertInvalid = cef_handler_errorcode_t.ERR_CERT_INVALID,
        CertEnd = cef_handler_errorcode_t.ERR_CERT_END,

        InvalidUrl = cef_handler_errorcode_t.ERR_INVALID_URL,
        DisallowedUrlScheme = cef_handler_errorcode_t.ERR_DISALLOWED_URL_SCHEME,
        UnknownUrlScheme = cef_handler_errorcode_t.ERR_UNKNOWN_URL_SCHEME,
        TooManyRedirects = cef_handler_errorcode_t.ERR_TOO_MANY_REDIRECTS,
        UnsafeRedirect = cef_handler_errorcode_t.ERR_UNSAFE_REDIRECT,
        UnsafePort = cef_handler_errorcode_t.ERR_UNSAFE_PORT,
        InvalidResponse = cef_handler_errorcode_t.ERR_INVALID_RESPONSE,
        InvalidChunkedEncoding = cef_handler_errorcode_t.ERR_INVALID_CHUNKED_ENCODING,
        MethodNotSupported = cef_handler_errorcode_t.ERR_METHOD_NOT_SUPPORTED,
        UnexpectedProxyAuth = cef_handler_errorcode_t.ERR_UNEXPECTED_PROXY_AUTH,
        EmptyResponse = cef_handler_errorcode_t.ERR_EMPTY_RESPONSE,
        ResponseHeadersTooBig = cef_handler_errorcode_t.ERR_RESPONSE_HEADERS_TOO_BIG,

        CacheMiss = cef_handler_errorcode_t.ERR_CACHE_MISS,

        InsecureResponse = cef_handler_errorcode_t.ERR_INSECURE_RESPONSE,
    }
